#!/bin/bash
# TimelockCoin Masternode Setup Script V2.1.1 for 20.04 Ubuntu LTS
#
...
wget https://github.com/IDCHAINGROUP/TYM/releases/download/v2.1.1/tym-2.1.1-Ubuntu20.04-daemon.tar.gz
tar -xzvf tym-2.1.1-Ubuntu20.04-daemon.tar.gz
